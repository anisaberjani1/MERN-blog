...
import { updateStart, updateSuccess, updateFailure, 
    deleteUserStart,deleteUserSuccess,deleteUserFailure,signoutSuccess} from '../redux/user/userSlice'
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <div className='text-red-500 flex justify-between mt-5'>
            ...
            <Button onClick={() => setShowModal(true)} type='submit' gradientMonochrome="failure" outline>
                Delete Account
            </Button>
            <Button onClick={handleSignout} type='submit' gradientMonochrome="failure" outline>
                Sign Out
            </Button>
        </div>
        {updateUserSuccess && (
